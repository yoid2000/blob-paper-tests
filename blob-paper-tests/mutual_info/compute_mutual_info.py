...
def check_pairs(file_path, blob_name, blob_dir_path):
    ...
    for col1, col2 in all_combs:
        ...
        # Get the number of distinct value pairs for col1 and col2 for both df_syn and df_orig
        num_unique_pairs_syn = df_syn[[col1, col2]].drop_duplicates().shape[0]
        num_unique_pairs_orig = df_orig[[col1, col2]].drop_duplicates().shape[0]
        ...
        this_result = {'blob_name':blob_name,
                        ...
                        'num_unique_pairs_orig':num_unique_pairs_orig,
                        'num_unique_pairs_syn':num_unique_pairs_syn,
